...
class App(tk.Tk):
    ...
    def show_current_image(self):
        if 0 <= self.current_image_index < len(self.image_files):
            ...
            image_path = self.directory_path + "\\\\" + self.image_files[self.current_image_index]
            print(image_path)
            image = Image.open(image_path)
    ...
    def drawfront(self):
        ...
        self.nav_label = ttk.Label(self.nav_frame, text="Навигация", font=("TkDefaultFont", 11))
        ...
        self.upload_label = ttk.Label(self.upload_section, text="Загрузка фото/директория", font=("TkDefaultFont", 11))
